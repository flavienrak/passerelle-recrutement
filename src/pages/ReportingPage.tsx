...
import { getCandidateFromFirestore, getInterviewsFromFirestore } from '../lib/utils';
...
const ClientReportPage: React.FC = () => {
    ...
    const getData = async () => {
        if (candidateEmail) {
            ...
            const interviews = await getInterviewsFromFirestore(candidateEmail);
            ...
            if (interviews.length > 0) {
                setInterviews(interviews[0].answers);
            }
        }
    };
