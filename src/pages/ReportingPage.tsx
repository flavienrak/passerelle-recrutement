...
export default function ClientReportPage() {
  ...
  const [userInfos, setUserInfos] = useState<UserInterface | null>(null);
            ...
            <div className="flex flex-col gap-12">
              ...
              <section className="flex flex-col gap-6">
                ...
                >
                  ...
                  <div className="space-y-4">
                    {userInfos.diplomes_anonym?.map((item, index) => (
                      <p
                ...
                >
                  <div className="space-y-6">
                    {userInfos.experiences_anonym?.map((item, index) => (
                      <div
                ...
                <section className="grid grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                  <div className="bg-[#1A1E2E]/80 backdrop-blur-sm rounded-xl border border-gray-700/50 p-6">
                    ...
                    <p className="text-gray-300 text-sm">
                      {
                        interviews.find((item) => item.questionNumber === 0)
                          ?.answer
                      }
                    </p>
                  </div>
                  ...
                  <div className="bg-[#1A1E2E]/80 backdrop-blur-sm rounded-xl border border-gray-700/50 p-6">
                    ...
                    <p className="text-gray-300 text-sm">
                      {
                        interviews.find((item) => item.questionNumber === 1)
                          ?.answer
                      }
                    </p>
                  </div>
                  ...
                  <div className="bg-[#1A1E2E]/80 backdrop-blur-sm rounded-xl border border-gray-700/50 p-6">
                    ...
                    <p className="text-gray-300 text-sm">
                      {
                        interviews.find((item) => item.questionNumber === 2)
                          ?.answer
                      }
                    </p>
                  </div>
                  ...
                  <div className="bg-[#1A1E2E]/80 backdrop-blur-sm rounded-xl border border-gray-700/50 p-6">
                    ...
                    <p className="text-gray-300 text-sm">
                      {
                        interviews.find((item) => item.questionNumber === 3)
                          ?.answer
                      }
                    </p>
                  </div>
                  ...
                  <div className="bg-[#1A1E2E]/80 backdrop-blur-sm rounded-xl border border-gray-700/50 p-6">
                    ...
                    <p className="text-gray-300 text-sm">
                      {
                        interviews.find((item) => item.questionNumber === 4)
                          ?.answer
                      }
                    </p>
                  </div>
                  ...
                  <div className="bg-[#1A1E2E]/80 backdrop-blur-sm rounded-xl border border-gray-700/50 p-6">
                    ...
                    <p className="text-gray-300 text-sm">
                      {
                        interviews.find((item) => item.questionNumber === 5)
                          ?.answer
                      }
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    >
                      ...
                      <p className="text-gray-300">
                        Mesure la capacité à décider rapidement et efficacement
                        en contexte humain et opérationnel tendu.
                      </p>
                    ...
                    >
                      ...
                      <p className="text-gray-300">
                        Analyse l'aptitude à gérer l'irréversible, à rebondir et
                        à s'adapter dans des situations critiques.
                      </p>
                      <div className="mt-auto pt-4">
                        <div className="flex justify-between text-sm text-gray-400">
                            ...
                            <div className="space-y-2">
                              ...
                              {selectedFamily === 'pilotageStrategique' && (
                                <p className="text-base font-medium text-[#FFF5E6] max-w-2xl">
                                  Profil décisionnel pragmatique avec excellente
                                  capacité de priorisation (85%). L'arbitrage
                                  humain (78%) montre un bon équilibre entre
                                  efficacité et considération des facteurs
                                  humains.
                                </p>
                              )}
                            </div>
                                ...
                                <div className="flex gap-8">
                                  <div className="bg-[#1A1E2E]/80 rounded-xl p-6 relative overflow-hidden group">
                                    ...
                                    <p className="text-gray-300 text-center">
                                      En réunion stratégique, vous identifiez
                                      avec précision le moment où une décision
                                      devient irréversible et devez trancher.
                                    </p>
                                  </div>
                                  ...
                                  <div className="bg-[#1A1E2E]/80 rounded-xl p-6 relative overflow-hidden group">
                                    ...
                                    <p className="text-gray-300 text-center">
                                      Suite à un projet non abouti, vous
                                      analysez objectivement la situation pour
                                      en tirer des apprentissages constructifs.
                                    </p>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="mt-6">
                                <div className="grid grid-cols-3 gap-6">
                                  <div className="bg-[#1A1E2E]/80 rounded-xl p-6 relative overflow-hidden group">
                                    ...
                                    <p className="text-gray-300 text-center">
                                      Capacité à adapter son approche
                                      managériale en temps réel selon les
                                  ...
                                  <div className="bg-[#1A1E2E]/80 rounded-xl p-6 relative overflow-hidden group">
                                    ...
                                    <p className="text-gray-300 text-center">
                                      Maintien d'une analyse objective des
                                      compétences même en contexte de forte
                                  ...
                                  <div className="bg-[#1A1E2E]/80 rounded-xl p-6 relative overflow-hidden group">
                                    ...
                                    <p className="text-gray-300 text-center">
                                      Détection naturelle des talents cachés et
                                      du potentiel inexploité dans l'équipe.
                                    </p>
                                  </div>
                                </div>
                              </div>
                              ...
                              <>
                                <div>
                                  ...
                                  <p className="mt-2 font-bold text-[#FF6B00]">
                                    Sur le terrain : Capacité exceptionnelle à
                                    identifier et traiter les urgences sans se
                                    disperser. Efficacité maximale sous
                                    pression.
                                  </p>
                                </div>
                                <div>
                                  ...
                                  <p className="mt-2 font-bold text-[#3B82F6]">
                                    Sur le terrain : Bon équilibre entre
                                    performance et facteur humain. Sait prendre
                                    des décisions difficiles sans créer de
                                    tensions.
                                  </p>
                                </div>
                              </>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="bg-[#0A0E17]/50 rounded-lg p-6">
                        ...
                        <p className="text-gray-300">
                          ...
                          points de non-retour (92%) et une forte capacité de
                          priorisation (85%). Sa flexibilité (90%) et sa lecture
                          adaptative (88%) sont remarquables, complétées par un
                          bon arbitrage humain (78%). Les axes de progression
                          concernent la stabilité sous pression (76%) et la
                          lecture intuitive (67%). Son score global de 84%
                          reflète un profil senior équilibré.
                        </p>
                      </div>
                    </div>
                  </div>
